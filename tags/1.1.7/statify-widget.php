...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('interval'); ?>">Letzten
			...
			<br /><small>0 Tage = Alles anzeigen</small>
		</p>
        <p>
...
function showErrorMessages() {
	...
	$html .= __( 'Bitte installieren und aktivieren Sie zuerst das <a target="_blank" href="http://wordpress.org/plugins/statify/">Statify</a> Plugin.', 'error-statify-widget' );
	$html .= '</p></div>';
	echo $html;
}
...
function get_statify_count($post_id) {
	return Statify_Posts::get_statify_count($post_id);
}
?>
